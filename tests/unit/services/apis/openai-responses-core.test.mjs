...
for (const { label, fields, expected } of [
  {
    ...
    fields: { json_schema: { description: 'An answer' } },
    expected: { name: 'response', strict: true, schema: {}, description: 'An answer' },
  },
  {
    label: 'empty top-level description takes precedence',
    fields: { description: '', json_schema: { description: 'Ignored' } },
    expected: { name: 'response', strict: true, schema: {}, description: '' },
  },
  {
